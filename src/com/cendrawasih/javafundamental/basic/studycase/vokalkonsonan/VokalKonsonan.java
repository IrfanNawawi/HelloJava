package com.cendrawasih.javafundamental.basic.studycase.vokalkonsonan;
...
public class VokalKonsonan {
    public static void main(String[] args) {
        ...
        System.out.println("Masukkan kalimat ajaib : ");
    ...
    private static int num_vokal(String word) {
        ...
        for (i = 0; i < word.length(); i++) {
            /* note : pastikan pada saat validasi dengan charAt huruf kapital atau non kapital sangat berpengaruh ke pengecekan
                      atau bisa menggunakan bilangan ASCI
            * */
