...
public class MultiDimensionalArray {
    public static void main(String[] args){
        ...
        // Dimensi 1 dengan indeks 0 memiliki panjang elemen 2
        arrChar[0][0] = 'A';
        arrChar[0][1] = 'B';

        // Dimensi 1 dengan indeks 1 memiliki panjang elemen 3
        arrChar[1][0] = 'C';
        arrChar[1][1] = 'D';
        arrChar[1][2] = 'E';

        // Tampilkan semua data dari dimensi yang memiliki indeks 0
        ...
        // Tampilkan semua data dari dimensi yang memiliki indeks 1
